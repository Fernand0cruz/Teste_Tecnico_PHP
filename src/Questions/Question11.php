    ...
    \App\Contracts\HasResponseInterface
{
    ...
    {
        return "Uma aplicação precisa consumir uma API de clientes fornecida por um parceiro.
...
Não é necessário implementar.";
    ...
    {
        return "- Para realizar a integracao com a API externa, eu utilizaria uma biblioteca HTTP confiavel, como Guzzle, para enviar requisicoes e receber respostas. Configuraria timeouts apropriados e implementaria retries com backoff exponencial para lidar com falhas de conexao temporarias.
